(async function () {
    ...
    $(".leaflet").each(async function () {
        ...
        if (map) {
                ...
                iconCreateFunction: function (cluster) {
                    ...
                    return L.divIcon({
                        html: `<div class="relative w-full h-full">
                                <div class="absolute inset-0 flex items-center justify-center rtl:mr-1.5 ltr:ml-1.5 mb-0.5 font-medium text-white">${cluster.getChildCount()}</div>
            ...
            locations.data.map(function (markerElem) {
